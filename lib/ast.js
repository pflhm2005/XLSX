...
export const generatecellXfsAst = (fontId, horizontal = 'left', vertical = 'center') => {
  return {
    n: 'xf', p: { 
      numFmtId: '0', 
      fontId, fillId: '0', 
...
export const generateSheetAst = (ref, SheetData, mergeAst) => {
  return {
    n: 'worksheet',
    p: {
      xmlns: 'http://schemas.openxmlformats.org/spreadsheetml/2006/main',
...
export const generateSharedStringAst = (map, count) => {
