...
export const generateSheetRelsAst = (idx) => {
  return {
    n: 'Relationships',
    p: {
    ...
    c: [
      {
        ...
        p: {
          ...
          Target: `../drawings/drawing${idx}.xml`
        }
      }
    ]
  };
...
export const generateDrawingRelsPathAst = (l, iidx) => {
  return {
    n: 'Relationships',
    p: {
      xmlns: 'http://schemas.openxmlformats.org/package/2006/relationships'
    },
    c: Array(l).fill().map((k, i) => ({
      n: 'Relationship',
      p: {
        Id: `rId${i + 1}`,
        Type: 'http://schemas.openxmlformats.org/officeDocument/2006/relationships/image',
        Target: `../media/image${iidx + i}.png`
      },
    }))
  };
}

export const generateDrawingAst = (imageList) => {
  return {
    n: 'xdr:wsDr',
    p: {
        ...
        c: [
          {
            n: 'xdr:from',
            c: [
              { n: 'xdr:col', t: o.xdrCol[0] },
              { n: 'xdr:colOff', t: o.xdrCol[2] },
              { n: 'xdr:row', t: o.xdrRow[0] },
              { n: 'xdr:rowOff', t: o.xdrRow[2] },
            ]
          },
          {
            n: 'xdr:to',
            c: [
              { n: 'xdr:col', t: o.xdrCol[1] },
              { n: 'xdr:colOff', t: o.xdrCol[3] },
              { n: 'xdr:row', t: o.xdrRow[1] },
              { n: 'xdr:rowOff', t: o.xdrRow[3] },
            ]
          },
          {
            n: 'xdr:pic',
            c: [
              {
                ...
                c: [
                  ...
                  {
                    n: 'xdr:cNvPicPr',
                    c: [{ n: 'a:picLocks', p: { noChangeAspect: '1' }}]
                  }
                ]
              },
              {
                n: 'xdr:blipFill',
                c: [
                  { n: 'a:blip', p: { 'r:embed': `rId${i + 1}` } },
                  { n: 'a:stretch', c: [{ n: 'a:fillRect' }]}
                ]
              },
              {
                n: 'xdr:spPr',
                c: [
                  {
                    n: 'a:xfrm',
                    c: [
                      { n: 'a:off', p: { x: '635', y: '635' } },
                      { n: 'a:ext', p: { cx: '6096000', cy: '5695950' } },
                    ],
                  },
                  {
                    n: 'a:prstGeom',
